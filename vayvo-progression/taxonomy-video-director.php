	...
	<div id="page-title-pro">
		<div id="progression-studios-page-title-container">
			<div class="width-container-pro">
				<h1 class="page-title"><?php if ( !empty( $term_photo ) ) : echo '<div id="skrn-video-cast-photo-taxonomy" style="background-image:url(' . $term_photo . ')"></div>'; endif; ?><?php esc_html_e( 'Director: ', 'vayvo-progression' ); ?><?php echo esc_attr('' . $term->name . '');?></h1>
