    ...
    <div id="boxed-layout-pro" <?php progression_studios_page_title(); ?>>
        ...
        <div id="progression-studios-header-position">
            ...
            <div id="progression-studios-header-width">
                ...
                <?php if (get_theme_mod( 'progression_studios_header_sticky', 'sticky-pro' ) == 'sticky-pro') : ?><div
                    id="progression-sticky-header"><?php endif; ?>
                    <header id="masthead-pro"
                        class="progression-studios-site-header <?php echo esc_attr( get_theme_mod('progression_studios_nav_align', 'progression-studios-nav-left') ); ?>">
                        <div id="logo-nav-pro">

                            <div class="width-container-pro progression-studios-logo-container">
                                <h1 id="logo-pro" class="logo-inside-nav-pro noselect">
                                    <?php //this is a place for logo. just comment line 40 ?>
                    ...
                    <?php if (get_theme_mod( 'progression_studios_header_sticky', 'sticky-pro' ) == 'sticky-pro' ) : ?>
                </div><!-- close #progression-sticky-header --><?php endif; ?>
